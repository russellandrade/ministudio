...
Page {
    Container {
        ...
        Container {   //xxxxx
            ...
            Container {  //record button container
                layout: StackLayout {
                ...
                ImageToggleButton {
                    ...
                    preferredWidth: 180.0
                    preferredHeight: 180.0
            ...
            }  // end record button container
           
            Container {  //tape container
                layout: StackLayout {
                    orientation: LayoutOrientation.TopToBottom
                }
            ...
            Container {  //misc button container
                layout: StackLayout {
                    orientation: LayoutOrientation.TopToBottom
                }
